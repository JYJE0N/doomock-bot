// src/managers/CallbackManager.js (간결한 버전)
...
class CallbackManager {
    ...
    initializeRoutes() {
        ...
        this.routes.set('cancel_action', { module: 'common', method: 'handleCancel' });
        ...
        this.routes.set('todo_clear_completed', { module: 'todo', method: 'clearCompleted' });
        ...
        this.routes.set('leave_history', { module: 'leave', method: 'showHistory' });
        this.routes.set('leave_setting', { module: 'leave', method: 'startSetting' });
        this.routes.set('use_leave_1', { module: 'leave', method: 'useOne' });
        this.routes.set('use_leave_0.5', { module: 'leave', method: 'useHalf' });
        this.routes.set('use_leave_custom', { module: 'leave', method: 'useCustom' });
        
        // 운세 관리
        this.routes.set('fortune_menu', { module: 'fortune', method: 'showMenu' });
        this.routes.set('fortune_general', { module: 'fortune', method: 'showGeneral' });
        this.routes.set('fortune_work', { module: 'fortune', method: 'showWork' });
        this.routes.set('fortune_love', { module: 'fortune', method: 'showLove' });
        this.routes.set('fortune_money', { module: 'fortune', method: 'showMoney' });
        this.routes.set('fortune_health', { module: 'fortune', method: 'showHealth' });
        this.routes.set('fortune_meeting', { module: 'fortune', method: 'showMeeting' });
        this.routes.set('fortune_tarot', { module: 'fortune', method: 'showTarot' });
        this.routes.set('fortune_lucky', { module: 'fortune', method: 'showLucky' });
        this.routes.set('fortune_all', { module: 'fortune', method: 'showAll' });
        
        // 타이머 관리
        this.routes.set('timer_menu', { module: 'timer', method: 'showMenu' });
        this.routes.set('timer_start_prompt', { module: 'timer', method: 'startPrompt' });
        ...
        this.routes.set('weather_current', { module: 'weather', method: 'showCurrent' });
        this.routes.set('weather_forecast', { module: 'weather', method: 'showForecast' });
        this.routes.set('weather_seoul', { module: 'weather', method: 'showSeoul' });
        this.routes.set('weather_busan', { module: 'weather', method: 'showBusan' });
        this.routes.set('weather_more_cities', { module: 'weather', method: 'showMoreCities' });
        
        // 인사이트 관리
        this.routes.set('insight_menu', { module: 'insight', method: 'showMenu' });
        this.routes.set('insight_full', { module: 'insight', method: 'showFull' });
        this.routes.set('insight_quick', { module: 'insight', method: 'showQuick' });
        this.routes.set('insight_dashboard', { module: 'insight', method: 'showDashboard' });
        this.routes.set('insight_national', { module: 'insight', method: 'showNational' });
        this.routes.set('insight_refresh', { module: 'insight', method: 'refresh' });
        
        // 유틸리티 관리
        this.routes.set('utils_menu', { module: 'utils', method: 'showMenu' });
        this.routes.set('utils_tts_menu', { module: 'utils', method: 'showTTSMenu' });
        this.routes.set('utils_tts_help', { module: 'utils', method: 'showTTSHelp' });
        this.routes.set('utils_help', { module: 'utils', method: 'showHelp' });
        
        // 리마인더 관리
        this.routes.set('reminder_menu', { module: 'reminder', method: 'showMenu' });
        this.routes.set('remind_minutes', { module: 'reminder', method: 'showMinutes' });
        this.routes.set('remind_time', { module: 'reminder', method: 'showTime' });
        this.routes.set('remind_help', { module: 'reminder', method: 'showHelp' });
        
        // 근무시간 관리
        this.routes.set('worktime_menu', { module: 'worktime', method: 'showMenu' });
    }
    ...
    async executeRoute(route, callbackQuery) {
        ...
        if (module && typeof module[methodName] === 'function') {
            await module[methodName](callbackQuery);
        } else {
            Logger.error(`모듈 또는 메소드를 찾을 수 없음: ${moduleName}.${methodName}`);
            await this.handleUnknownCallback(callbackQuery);
        }
    }
