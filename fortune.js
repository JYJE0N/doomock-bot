class FortuneManager {
  constructor() {
    this.messages = {
      ...
      tarot: [
        { name: "The Fool", meaning: "새로운 시작과 순수한 마음으로 모험을 떠날 때", emoji: "🃏", advice: "두려워하지 말고 첫 걸음을 내디디세요" },
        { name: "The Magician", meaning: "의지와 집중력으로 원하는 것을 현실로 만들 수 있는 날", emoji: "🔮", advice: "자신의 능력을 믿고 행동하세요" },
        { name: "The High Priestess", meaning: "직감과 내면의 지혜가 빛을 발하는 날", emoji: "🌙", advice: "논리보다는 직감을 따르세요" },
        { name: "The Empress", meaning: "풍요로움과 창조성, 모성애가 넘치는 날", emoji: "👸", advice: "사랑과 돌봄을 베풀어보세요" },
        { name: "The Emperor", meaning: "권위와 리더십, 안정성이 강조되는 날", emoji: "👑", advice: "계획을 세우고 체계적으로 행동하세요" },
        { name: "The Hierophant", meaning: "전통과 가르침, 영적 성장의 기회가 오는 날", emoji: "⛪", advice: "멘토나 선배의 조언에 귀 기울이세요" },
        { name: "The Lovers", meaning: "사랑과 선택, 조화로운 관계가 중요한 날", emoji: "💕", advice: "마음을 열고 진실한 감정을 표현하세요" },
        { name: "The Chariot", meaning: "의지력과 결단력으로 승리를 쟁취하는 날", emoji: "🏎️", advice: "목표를 향해 당당히 전진하세요" },
        { name: "Strength", meaning: "용기와 인내, 내면의 힘이 필요한 날", emoji: "💪", advice: "어려움을 부드러움으로 극복하세요" },
        { name: "The Hermit", meaning: "성찰과 깨달음, 혼자만의 시간이 필요한 날", emoji: "🔦", advice: "내면을 돌아보며 지혜를 찾으세요" },
        { name: "Wheel of Fortune", meaning: "운명의 전환점, 행운의 바퀴가 돌아가는 날", emoji: "🎡", advice: "변화를 받아들이고 기회를 잡으세요" },
        { name: "Justice", meaning: "공정함과 균형, 올바른 판단이 중요한 날", emoji: "⚖️", advice: "공정하고 균형잡힌 선택을 하세요" },
        { name: "The Hanged Man", meaning: "희생과 기다림, 새로운 관점이 필요한 날", emoji: "🙃", advice: "다른 시각으로 상황을 바라보세요" },
        { name: "Death", meaning: "변화와 재탄생, 끝과 새로운 시작의 날", emoji: "🦋", advice: "과거를 놓아주고 새롭게 시작하세요" },
        { name: "Temperance", meaning: "절제와 조화, 균형잡힌 삶의 중요성", emoji: "🧘‍♀️", advice: "극단을 피하고 중도를 택하세요" },
        { name: "The Devil", meaning: "유혹과 속박, 내면의 그림자와 마주하는 날", emoji: "😈", advice: "자신을 구속하는 것들로부터 자유로워지세요" },
        { name: "The Tower", meaning: "급작스러운 변화와 깨달음의 순간", emoji: "⚡", advice: "예상치 못한 변화에 당황하지 마세요" },
        { name: "The Star", meaning: "희망과 영감, 꿈을 향한 확신의 날", emoji: "⭐", advice: "꿈을 포기하지 말고 희망을 품으세요" },
        { name: "The Moon", meaning: "환상과 직감, 무의식의 메시지를 받는 날", emoji: "🌙", advice: "겉모습에 속지 말고 본질을 보세요" },
        { name: "The Sun", meaning: "기쁨과 성공, 모든 것이 밝게 빛나는 날", emoji: "☀️", advice: "긍정적인 에너지로 하루를 채우세요" },
        { name: "Judgement", meaning: "심판과 부활, 과거를 정리하고 새롭게 태어나는 날", emoji: "📯", advice: "과거를 용서하고 새로운 자신을 만나세요" },
        { name: "The World", meaning: "완성과 성취, 모든 것이 완전해지는 날", emoji: "🌍", advice: "목표를 달성하고 다음 단계를 준비하세요" }
      ]
    };
  }
