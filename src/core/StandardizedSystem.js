...
const STANDARD_PARAMS = {
  ...
  // 콜백 처리: (bot, callbackQuery, subAction, params, moduleManager)
  CALLBACK_HANDLER: [
    "bot",
    "callbackQuery",
    "subAction",
...
class StandardizedBaseModule {
  ...
  async _processCallback(bot, callbackQuery, subAction, params, moduleManager) {
    throw new Error(
