...
class ReminderModule extends BaseModule {
    ...
    async handleCallback(bot, callbackQuery, subAction, params, menuManager) {
        ...
        switch (subAction) {
            case 'menu':
                await this.showReminderMenu(bot, chatId, messageId, userName, menuManager);
                break;
            case 'minutes':
            ...
            case 'help':
                ...
                break;
            default:
                await this.sendMessage(bot, chatId, '❌ 알 수 없는 리마인더 명령입니다.');
        }
    }
    ...
    async handleReminderCommand(bot, msg) {
        ...
        try {
            ...
            await this.sendMessage(bot, chatId, '❌ 리마인더 설정 중 오류가 발생했습니다.');
        }
    }
