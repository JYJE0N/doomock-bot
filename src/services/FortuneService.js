  ...
  initializeTarotCards() {
    ...
    this.majorArcana = [
      ...
      },
      {
        ...
        emoji: "🌙",
        advice: "내면의 목소리에 귀 기울이세요.",
      },
      {
        name: "The Empress",
        meaning: "풍요, 모성애, 창조성",
        emoji: "👸",
        advice: "사랑과 돌봄을 아낌없이 나누세요.",
      },
      {
        name: "The Emperor",
        meaning: "권위, 리더십, 질서",
        emoji: "👑",
        advice: "책임감을 갖고 체계적으로 행동하세요.",
      },
      {
        name: "The Hierophant",
        meaning: "전통, 교육, 영적 지혜",
        emoji: "⛪",
        advice: "멘토의 조언을 구하고 전통을 존중하세요.",
      },
      {
        name: "The Lovers",
        meaning: "사랑, 선택, 조화",
        emoji: "💕",
        advice: "마음이 이끄는 대로 선택하세요.",
      },
      {
        name: "The Chariot",
        meaning: "승리, 의지, 전진",
        emoji: "🏎️",
        advice: "목표를 향해 흔들림 없이 나아가세요.",
      },
      {
        name: "Strength",
        meaning: "내적 힘, 용기, 인내",
      ...
      },
      {
        ...
        meaning: "성찰, 고독, 내면의 빛",
        emoji: "🔦",
        advice: "혼자만의 시간을 갖고 자신을 돌아보세요.",
      },
      {
        name: "Wheel of Fortune",
        meaning: "운명, 변화, 기회",
        emoji: "☸️",
        advice: "변화를 받아들이고 흐름에 맡기세요.",
      },
      {
        name: "Justice",
        meaning: "정의, 균형, 진실",
        emoji: "⚖️",
        advice: "공정하게 판단하고 정직하게 행동하세요.",
      },
      {
        name: "The Hanged Man",
        meaning: "희생, 새로운 관점, 인내",
        emoji: "🙃",
        advice: "다른 시각으로 상황을 바라보세요.",
      },
      {
        name: "Death",
        meaning: "변화, 끝과 시작, 변환",
        emoji: "💀",
        advice: "낡은 것을 버리고 새로운 것을 받아들이세요.",
      },
      {
        name: "Temperance",
        meaning: "절제, 균형, 조화",
        emoji: "🏺",
        advice: "중용을 지키며 균형잡힌 삶을 추구하세요.",
      },
      {
        name: "The Devil",
        meaning: "속박, 유혹, 물질주의",
      ...
      {
        name: "The Tower",
        meaning: "급격한 변화, 계시, 해방",
        emoji: "🏰",
        advice: "무너진 곳에서 새로운 것을 건설하세요.",
      },
      {
        name: "The Star",
        meaning: "희망, 영감, 평화",
      ...
      },
      {
        ...
        meaning: "환상, 불안, 잠재의식",
        emoji: "🌕",
        advice: "두려움에 맞서고 진실을 찾으세요.",
      },
      {
        name: "The Sun",
        meaning: "기쁨, 성공, 활력",
        emoji: "☀️",
        advice: "긍정적인 에너지로 세상을 밝히세요.",
      },
      {
        name: "Judgement",
        meaning: "심판, 각성, 재생",
